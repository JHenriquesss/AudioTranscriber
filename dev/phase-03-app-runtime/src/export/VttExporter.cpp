...
VttExporter::render(const transcription::TranscriptDocument &transcript) {
...
shared::Result<void> VttExporter::exportToFile(const transcription::TranscriptDocument &transcript,
